...
export class TableComponent implements OnInit {
    ...
    public data: { [key: string]: any } []= [
      {  id:  1,  what: 1, num:  'Ins_1', amount: 1000, userType: 'user', clientId: 1, description: 'Insurance policy number PN1' },
    ...
    // getAllProperties() {
    //   this.policies.forEach((element: IPolicy) => {
    //     this.properties = Object.getOwnPropertyNames(element)
    //   });
    // }
  }
